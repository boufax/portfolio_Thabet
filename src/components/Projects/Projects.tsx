...
const projectsFR: Project[] = [
    ...
    },
    {
        id: "p9",
        icon: TrendingUp,
        title: "Stratégie pricing et clustering clients pour Renault Trucks",
        ...
        result: "Segmentation en 4 profils clients actionnables, construction d'un score de potentiel de conquête et dashboard Power BI présenté aux directeurs régionaux et au management.",
    ...
    },
    {
        id: "p10",
        icon: Cloud,
        title: "Pipeline de données temps réel sur Azure pour Vélib",
...
const projectsEN: Project[] = [
    ...
    },
    {
        id: "p9",
        icon: TrendingUp,
        title: "Pricing Strategy and Customer Clustering for Renault Trucks",
    ...
    },
    {
        id: "p10",
        icon: Cloud,
        title: "Real-Time Data Pipeline on Azure for Vélib",
