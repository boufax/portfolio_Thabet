...
const translations = {
    FR: {
        ...
        "about.p3": "Animé par une forte ambition internationale, je suis ouvert à des opportunités en France comme à l'étranger, au sein de grands groupes ou d'environnements à fort impact data.",
        "about.p3.highlight": "fort impact data",
    ...
    EN: {
        ...
        "about.p1": "My approach to data is built on a simple principle: structure, analyze, and leverage data to generate value.",
        "about.p1.highlight": "generate value",
        "about.p2": "I work at the intersection of data engineering, analytics, and business to transform complex data into actionable insights and strategic decisions.",
        "about.p2.highlight": "strategic decisions",
        "about.p3": "Driven by strong international ambitions, I am open to opportunities both in France and abroad, within large organizations or high-impact data environments.",
        "about.p3.highlight": "high-impact data environments",
        "skills.title": "Skills",
